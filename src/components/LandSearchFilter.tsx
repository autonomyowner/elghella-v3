...
export default function LandSearchFilter({
  ...
  }, [priceRange, rating, landType, searchQuery]);

  const landTypes = [
    { value: "", label: "جميع الأراضي" },
    { value: "أرض زراعية", label: "أرض زراعية" },
    { value: "بستان", label: "بستان" },
    { value: "مرعى", label: "مرعى" },
    { value: "غابة", label: "غابة" },
  ...
  return (
    <div className="bg-gray-800 shadow-lg rounded-lg p-6 sticky top-20 border border-gray-700 transition-colors duration-300">
      ...
      {/* Land Type Filter */}
      <div className="mb-6">
        <label className="block text-sm font-mediumtext-gray-300 mb-2">
          نوع الأرض
        </label>
        <select
          value={landType}
